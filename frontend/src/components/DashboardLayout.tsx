...
const DashboardLayout: React.FC = () => {
    ...
    const drawerContent = (
        <Box sx={{ width: drawerWidth, bgcolor: '#3834a4', height: '100%' }}>
            ...
            <List>
                {[
                    { text: 'General', icon: <HomeIcon />, path: '/overview' },
                    { text: 'Préstamos', icon: <CalendarIcon />, path: '/loans' },
                    { text: 'Libros', icon: <AutoStoriesOutlinedIcon />, path: '/books' },
                    { text: 'Autores', icon: <AssignmentIcon />, path: '/authors' },
